...
namespace Interface
{
    ...
    void print_note(const severaldatatype& note,
        const severaldatatype& note_head = "No title",
        bool _clrscr = true,
        std::ostream& out = std::cout);

    // print a table (/w title).
    void print_table(const table& tabl,
        const severaldatatype& tabl_head = "No title",
        bool _nocolumn = true,
        bool _vertical = true,
        bool _clrscr = true,
        std::ostream& out = std::cout);
    ...
    public:
        ...
        void add_item(const int no, const severaldatatype& desc);

        // remove an item from the menu by number.
        bool remove_item_by_no(const int no);

        // set the title of the menu.
        void set_title(const severaldatatype& e);
        ...
        severaldatatype print_menu_and_wait(bool _clrscr = true, std::ostream& out = std::cout) const;
    };
    ...
    public:
        ...
        void add_item(const severaldatatype& desc, bool line_input = true);

        // remove an item from the menu by description.
        bool remove_item_by_desc(const severaldatatype& desc, bool strict = false);
        ...
        list<severaldatatype> print_menu_and_wait(bool _clrscr = true, std::ostream& out = std::cout) const;
    };
}
